...
// --- Colonnes pour le système de Parrainage ---
const COLONNE_CODE_PARRAINAGE = "Code de Parrainage";
const COLONNE_CODE_UTILISE = "Code Utilisé";
const COLONNE_CREDIT_PARRAINAGE = "Crédit Parrainage";
